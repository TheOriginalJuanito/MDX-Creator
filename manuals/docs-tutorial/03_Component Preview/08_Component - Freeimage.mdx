...
<FreeImage aspectRatio='16/9'>
    <ImgPosition Top='50%' Left='25%' Width='100px' src='/img/logo.png' Border='10px' />
    <ImgPosition Top='20%' Left='75%' Width='200px' src='/img/logo.png' Border='25px' />
    <ImgPosition Top='75%' Left='50%' Width='50px' src='/img/logo.png' Border='8px' />
</FreeImage>
